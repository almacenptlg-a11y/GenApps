...
function renderWelcomeBanner(nombre) {
   ...
   // APLICANDO DISEÑO DE TARJETA FLOTANTE (Glassmorphism)
    document.getElementById('welcome-banner').innerHTML = `
        <div class="flex items-center gap-3 sm:gap-6 p-4 sm:p-6 rounded-2xl sm:rounded-[2rem] bg-white/80 dark:bg-gray-800/80 backdrop-blur-md shadow-lg border border-white/50 dark:border-gray-700/50 relative overflow-hidden transition-all hover:shadow-xl">
